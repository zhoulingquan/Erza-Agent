...
from erza.agent import model_presets as preset_helpers
from erza.agent import turn_telemetry
from erza.agent._mcp_lifecycle import McpLifecycleMixin
from erza.agent._provider_switching import ProviderSwitchingMixin
...
from erza.agent.subagent_registry import SubagentDefinition, SubagentRegistry
...
from erza.session.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from erza.session.manager import Session, SessionManager
from erza.session.webui_turns import (
    WebuiTurnCoordinator,
    build_bus_progress_callback,
)
from erza.tools.context import (
    RequestContext,
...
class AgentLoop(StateMixin, ProviderSwitchingMixin, McpLifecycleMixin):
    ...
    def _init_execution_limits(self, cfg: AgentLoopConfig, defaults: AgentDefaults) -> None:
        ...
        # ``ERZA_NO_AUTO_LOOKUP=1`` also fails loud here (the error
        # message tells the user to set context_window_tokens explicitly).
        if self.context_window_tokens is None:
            from erza.providers.model_catalog import get_model_context_limit
        ...
        from erza.providers.model_catalog import DEFAULT_CONTEXT_LIMIT
    ...
    def _set_tool_context(
        ...
        from erza.tools.context import ContextAware
    ...
    def _build_agent_run_spec(
        ...
        return AgentRunSpec(
            ...
            # Sustained goals may legitimately exceed ERZA_LLM_TIMEOUT_S; idle stall
            # is still capped by ERZA_STREAM_IDLE_TIMEOUT_S in streaming providers.
