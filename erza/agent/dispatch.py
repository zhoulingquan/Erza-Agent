...
class MessageDispatcher:
    ...
    def __init__(
        ...
        # ERZA_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("ERZA_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    async def _dispatch_command_inline(
        ...
        (``erza/command/service.py``); this thin shim forwards to it so
